...
if(!eregi("^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$", $emailEntered)){
    ...
    header("Location:../registerEmailInvalid.php");
    exit;
}
...
echo 'registration email was sent out. Be sure you check your email for a verification email from Big Sky Strong!';
